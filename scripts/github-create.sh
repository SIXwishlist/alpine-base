...
echo "Will create a new *$PRIVACYWORD* repo named alpine-base"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Alpine Linux Base contains all the boilerplate you need to create an Docker container using latest stable Alpine linux minimal system.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"alpine-base\", \"description\": \"Alpine Linux Base contains all the boilerplate you need to create an Docker container using latest stable Alpine linux minimal system.\", \"private\": $PRIVATE_TF}"
